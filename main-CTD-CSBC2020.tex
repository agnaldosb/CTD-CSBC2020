...
\usepackage{multirow} %mesclar múltiplas linhas em tabelas
\usepackage{bigstrut} %linhas de tabelas mais altas
...
\usepackage{float}
%% ------ FIM DOS PACOTES PERSONALIZADOS ------
...
% comandos de configuração para comentários
...
%Portanto, a verificação da confiança dos dispositivos 
%\as{, recomendação de confiança/ Porque eu não destaco as caraterística deste ambiente e depois onde eu posso encontrar isso (principios).}
...
%estruturas hospitalares  \as{e domiciliar}\agn{es}. 
...
%\as{Para lidar com esse  desafio,} 
